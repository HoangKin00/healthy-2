...
<div class="container">
    <div class="col-8">
        <div class="card card-info">
            ...
            <form class="form-horizontal" action="{{route('categoryProduct.add')}}" method="POST">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">
                            ...
                            <div class="form-check">
                                <input type="radio" name="status" id="input" value="2" checked>
                ...
                <div class="card-footer">
                    <a href=""> <button type="submit" class="btn btn-info"><i class="fas fa-save"></i> Lưu
                            Lại</button></a>
                    <a href="{{route('categoryProduct.index')}}" class="btn btn-default float-right"><i
                            class="fas fa-arrow-left"></i> Bỏ qua </a>
                </div>
                <!-- /.card-footer -->
            </form>
        </div>

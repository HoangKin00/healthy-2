    ...
    <div class="d-flex">
        <form class="form-inline">
            <div class="form-group">
                <input class="form-control " name="key" type="search" placeholder="Tìm kiếm" aria-label="Search"
                    value="{{request()->key}}">
            </div>
        ...
        <a href="{{route('categoryProduct.create')}}" type="button" class="btn btn-info" style="margin-left: 15px;"><i
        ...
        <a href="" type="button" class="btn btn-danger btn-delete-all ml-2"><i class="fas fa-trash nav-icon"> Xóa lựa
                chọn </i></a>
        <a href="{{route('categoryProduct.trashed')}}" class="btn btn-warning ml-2">Thùng rác <i
                class="fas fa-trash-restore"></i></a>
    </div>
    <hr>
    <form action="{{route('categoryProduct.clear')}}" method="POST" id="formDeleteAll">
        @csrf @method('DELETE')
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            <a href="{{route('categoryProduct.edit',$cat->id)}}" class="btn btn-primary"
                                style="margin-right: 10px;"><i class="fas fa-edit"></i></a>
                            <a href="{{route('categoryProduct.destroy', $cat->id)}}"

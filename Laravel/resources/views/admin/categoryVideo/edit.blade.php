...
@section('title','Sửa Danh Mục Video')
@section('main')
<div class="container">
    <div class="col-8">
        <div class="card card-info">
            ...
            <form class="form-horizontal" action="{{route('categoryVideo.update', $cat->id)}}" method="POST">
                @csrf @method('PUT')
                ...
                <div class="card-footer">
                    <a href=""> <button type="submit" class="btn btn-info"><i class="fas fa-save"></i>Lưu
                            Lại</button></a>
                    <a href="{{route('categoryVideo.create')}}"> <button type="submit"

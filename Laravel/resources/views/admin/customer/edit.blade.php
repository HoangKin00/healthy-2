            ...
            <form action="{{route('customer.update', $cus->id)}}" method="POST">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="" name="name" class="form-control" id="exampleInputEmail1"
                            placeholder="Tên Người Dùng" value="{{$cus->name}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="" name="address" class="form-control" id="exampleInputPassword1"
                            placeholder="Địa Chỉ" value="{{$cus->address}}">
                ...
                <div class="card-footer">
                    <a href=""> <button type="submit" class="btn btn-info"><i class="fas fa-save"></i>Lưu
                            Lại</button></a>
                    <a href="{{route('customer.index')}}"> <button type="submit" class="btn btn-default float-right"><i

...
<div class="container">
    <div class="d-flex">
        ...
        <a href="{{route('customer.trashed')}}" class="btn btn-warning ml-2">Thùng rác <i class="fas fa-trash-restore"></i></a>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex">
                        ...
                        <a href="{{route('customer.destroy', $cus->id)}}" onclick="return confirm('Bạn có chắc muốn xóa không?');" class="btn btn-danger btn-delete btn-single-delete"><i class="fas fa-trash"></i></a>
                    </div>
                </td>
            </tr>

...
<div class="container">
    <div class="d-flex">
        ...
        <a href="{{route('categoryVideo.create')}}" type="button" class="btn btn-info" style="margin-left: 15px;"><i
        ...
        <a href="" type="button" class="btn btn-danger btn-delete-all ml-2"><i class="fas fa-trash nav-icon"> Xóa lựa
                chọn </i></a>
        <a href="{{route('categoryVideo.trashed')}}" class="btn btn-warning ml-2">Thùng rác <i class="fas fa-trash-restore"></i></a>

    </div>
    <hr>
    <form action="{{route('categoryVideo.clear')}}" method="POST" id="formDeleteAll">
        @csrf @method('DELETE')
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            <a href="{{route('categoryVideo.edit',$cat->id)}}" class="btn btn-primary"
                                style="margin-right: 10px;"><i class="fas fa-edit"></i></a>
                            <a href="{{route('categoryVideo.destroy', $cat->id)}}"

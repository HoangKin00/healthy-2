...
@section('title','Thêm Mới Danh Mục Blog')
@section('main')
<div class="container">
    <div class="col-8">
        <div class="card card-info">
            ...
            <form class="form-horizontal" action="{{route('categoryBlog.add')}}" method="POST">
                @csrf
                <div class="card-body">
                ...
                <div class="card-footer">
                    <a href=""> <button type="submit" class="btn btn-info"><i class="fas fa-save"></i>Lưu
                            Lại</button></a>
                    <a href="{{route('categoryBlog.index')}}"> <button type="submit" class="btn btn-default float-right"><i class="fas fa-arrow-left"></i>Bỏ qua</button></a>
                </div>
                <!-- /.card-footer -->
            </form>
        </div>
